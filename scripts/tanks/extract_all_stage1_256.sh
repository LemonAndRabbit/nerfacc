...
new_tag=vanilla_adapt_bg_0.2_center_loss_e35k_nodecay_asize_256
...
do
    ...
    ${set_cuda} python examples/extract_mesh.py --scene ${scene} --load_path ${new_dir}/${scene} --mesh_level 0.4 --grid_size 256
done
