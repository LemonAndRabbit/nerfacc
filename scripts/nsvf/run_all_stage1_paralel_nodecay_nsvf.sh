...
data_root=/data/zhifan/data/Synthetic_NSVF/
single=true
tag=vanilla_random_bg_0.2_center_loss_e35k_nodecay_asize
...
# DATASETS=("Wineholder" "Steamtrain" "Spaceship" "Palace" "Bike" "Robot" "Lifestyle" "Toad")
DATASETS=("Palace")
# date
# tag=$(date +'%Y-%m-%d')
idx=0
